...
export const metadata: Metadata = {
  title: "Contact | RestauPilot",
  description: "Contactez l'équipe RestauPilot",
}
        ...
        <section className="bg-gradient-to-b from-muted/50 to-background py-20">
          <div className="container">
            <div className="mx-auto max-w-3xl text-center">
              <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Contactez-nous</h1>
                  ...
                  <Card>
                    <CardContent className="flex items-start gap-4 p-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground mt-1">
                          <a href="mailto:contact@restaupilot.com" className="hover:underline">
                            contact@restaupilot.com
                          </a>
                        </p>
                        <p className="text-muted-foreground">
                          <a href="mailto:support@restaupilot.com" className="hover:underline">
                            support@restaupilot.com
                          </a>
                        </p>
                      </div>
                    </CardContent>
