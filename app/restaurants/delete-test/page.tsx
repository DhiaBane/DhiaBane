...
export default function DeleteRestaurantsPage() {
  ...
  // Créer directement le client Supabase au lieu d'utiliser getSupabaseBrowserClient
  // Cette approche évite les problèmes potentiels avec le singleton pattern
  ...
  const fetchRestaurants = async () => {
    ...
    try {
      ...
      console.log("Clé API (début):", process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY?.substring(0, 5))
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Test de suppression des restaurants</h1>
        <Link
          href="/dashboard"
      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-6 text-sm">
        ...
        <p className="mt-2 text-blue-600">
          <strong>Note:</strong> Cette page utilise createClient() directement au lieu de getSupabaseBrowserClient()
        </p>
      </div>
