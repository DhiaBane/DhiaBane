    ...
    <Dialog open={showNewTeamDialog} onOpenChange={setShowNewTeamDialog}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Ajoutez un nouveau restaurant à votre compte.</DialogDescription>
        </DialogHeader>
        <div>
          <div className="space-y-4 py-2 pb-4">
            <div className="space-y-2">
              <Label htmlFor="name">Nom du restaurant</Label>
              <Input id="name" placeholder="Le Gourmet" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="plan">Type de restaurant</Label>
              <Select>
                <SelectTrigger>
                  <SelectValue placeholder="Sélectionner un type" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="free">Restaurant traditionnel</SelectItem>
                  <SelectItem value="pro">Fast-food</SelectItem>
                  <SelectItem value="premium">Gastronomique</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
